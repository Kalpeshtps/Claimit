...
WebUI.click(findTestObject('Page_ClaimIt Admin/span_Participants List'))

WebUI.setText(findTestObject('Page_ClaimIt Admin/input'), '419-392-8672')

WebUI.click(findTestObject('Page_ClaimIt Admin/a_View'))

WebUI.click(findTestObject('Page_ClaimIt Admin/a_View_1'))

WebUI.scrollToPosition(110, 230)
