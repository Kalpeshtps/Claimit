...
WebUI.setText(findTestObject('Object Repository/Screening Approval/Page_ClaimIt Admin/input'), '766-180')
...
WebUI.click(findTestObject('Screening Reject/Screeninig Reject Popup/Page_ClaimIt Admin/label_Reject'))

WebUI.click(findTestObject('Object Repository/Screening Reject/Screeninig Reject Popup/Page_ClaimIt Admin/h4_Screen Fail Reason'))
