...
WebUI.click(findTestObject('Page_ClaimIt Admin/input_concat(Participant  s Date of Birth)_mothers_birth_date'))

WebUI.click(findTestObject('Page_ClaimIt Admin/td_1'))
